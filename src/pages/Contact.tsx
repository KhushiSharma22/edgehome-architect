...
// Light Architectural Background Layer
const ArchitecturalBackground = () => {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      {/* Warm cream base gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#FAF8F5] via-[#F5F2ED] to-[#EDE9E3]" />
      
      {/* Subtle warm overlay */}
      <div className="absolute inset-0 bg-gradient-to-tr from-primary/[0.03] via-transparent to-primary/[0.02]" />
      
      {/* Blueprint grid - angled - subtle on light */}
      <div 
        className="absolute inset-0 opacity-[0.04]"
        style={{
          backgroundImage: `
            linear-gradient(rgba(13, 13, 13, 0.15) 1px, transparent 1px),
            linear-gradient(90deg, rgba(13, 13, 13, 0.15) 1px, transparent 1px)
          `,
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(199, 163, 107, 0.4) 1px, transparent 1px),
            linear-gradient(90deg, rgba(199, 163, 107, 0.4) 1px, transparent 1px)
          `,
      ...
      <svg className="absolute inset-0 w-full h-full opacity-[0.06]" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice">
        {/* Structural lines */}
        <line x1="200" y1="0" x2="200" y2="1080" stroke="#0D0D0D" strokeWidth="0.5" />
        <line x1="1720" y1="0" x2="1720" y2="1080" stroke="#0D0D0D" strokeWidth="0.5" />
        
        {/* Horizontal architectural lines */}
        <line x1="0" y1="250" x2="400" y2="250" stroke="#C7A36B" strokeWidth="0.8" />
        <line x1="1520" y1="350" x2="1920" y2="350" stroke="#C7A36B" strokeWidth="0.8" />
        
        {/* Abstract building forms - gold accent */}
        <rect x="60" y="150" width="100" height="300" fill="none" stroke="#C7A36B" strokeWidth="0.5" />
        <rect x="1760" y="200" width="80" height="250" fill="none" stroke="#C7A36B" strokeWidth="0.5" />
        
        {/* Diagonal compositional lines */}
        <line x1="0" y1="0" x2="500" y2="350" stroke="#0D0D0D" strokeWidth="0.3" strokeDasharray="6 12" />
        <line x1="1920" y1="0" x2="1500" y2="300" stroke="#0D0D0D" strokeWidth="0.3" strokeDasharray="6 12" />
      </svg>
      
      {/* Warm ambient glows */}
      <div className="absolute top-0 right-0 w-[800px] h-[600px] bg-gradient-to-bl from-primary/[0.06] to-transparent blur-3xl" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[500px] bg-gradient-to-tr from-primary/[0.04] to-transparent blur-3xl" />
      
      {/* Corner architectural details */}
      <div className="absolute top-12 left-12 w-20 h-20 opacity-[0.12]">
        <div className="absolute top-0 left-0 w-full h-[1px] bg-background" />
        <div className="absolute top-0 left-0 w-[1px] h-full bg-background" />
        <div className="absolute top-3 left-3 text-[7px] text-background/80 font-mono tracking-[0.2em]">PLAN 01</div>
      </div>
      <div className="absolute top-12 right-12 w-20 h-20 opacity-[0.12]">
        <div className="absolute top-0 right-0 w-full h-[1px] bg-background" />
        <div className="absolute top-0 right-0 w-[1px] h-full bg-background" />
      </div>
      <div className="absolute bottom-12 left-12 w-20 h-20 opacity-[0.12]">
        <div className="absolute bottom-0 left-0 w-full h-[1px] bg-background" />
        <div className="absolute bottom-0 left-0 w-[1px] h-full bg-background" />
      </div>
      <div className="absolute bottom-12 right-12 w-20 h-20 opacity-[0.12]">
        <div className="absolute bottom-0 right-0 w-full h-[1px] bg-background" />
        <div className="absolute bottom-0 right-0 w-[1px] h-full bg-background" />
        <div className="absolute bottom-3 right-3 text-[7px] text-background/80 font-mono tracking-[0.2em]">SEC A-A</div>
      </div>
...
// Project type selector - Light theme
...
// Zone wrapper with crop marks - Light theme
const ZoneWrapper = ({ children, label, className = '' }: { children: React.ReactNode; label: string; className?: string }) => {
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Zone label */}
      <div className="absolute -top-8 left-0 text-[8px] font-mono tracking-[0.3em] text-primary/60 uppercase font-medium">
        {label}
      </div>
...
const Contact = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen relative overflow-hidden">
      ...
      <div 
        className="fixed w-[500px] h-[500px] rounded-full pointer-events-none transition-all duration-1000 ease-out opacity-[0.08]"
        style={{
          background: 'radial-gradient(circle, rgba(199,163,107,0.5) 0%, transparent 70%)',
      ...
      <main className="relative z-10">
        {/* Hero Moment */}
        <section className="min-h-[55vh] flex items-center justify-center px-6 pt-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            {/* Main line */}
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-light text-background mb-6 leading-relaxed animate-fade-in"
            ...
            {/* Subtle subtext */}
            <p className="text-base md:text-lg text-background/60 font-body font-light max-w-xl mx-auto animate-fade-in"
            ...
            <div className="grid lg:grid-cols-12 gap-16 lg:gap-12">
              ...
              <div className="lg:col-span-7 lg:pr-8">
                <ZoneWrapper label="Zone 01 — Speak to Us">
                  <div className="p-8 md:p-10 bg-white/40 backdrop-blur-sm rounded-2xl border border-white/60 shadow-[0_8px_40px_rgba(0,0,0,0.06)]">
                    {/* Form heading */}
                    <div className="mb-10">
              ...
              <div className="lg:col-span-5 space-y-12">
                ...
                <ZoneWrapper label="Zone 02 — Where We Work">
                  <div className="p-8 bg-background/[0.03] backdrop-blur-sm rounded-2xl border border-background/10">
                    {/* City name */}
                    <div className="mb-6">
                    ...
                    <div className="relative h-28 mb-6 overflow-hidden opacity-40">
                      <svg viewBox="0 0 200 80" className="w-full h-full">
                        ...
                        {[...Array(4)].map((_, i) => (
                          <line key={`h${i}`} x1="0" y1={i * 20} x2="200" y2={i * 20} stroke="#0D0D0D" strokeWidth="0.1" />
                        ))}
                      </svg>
                    </div>
                  ...
                  <div className="p-6 bg-primary/[0.08] rounded-2xl border border-primary/20">
                    ...
                    <div className="flex gap-4">
                      ...
                      >
                        ...
                        <span className="text-xs font-mono tracking-wider text-background/70 group-hover:text-background font-medium transition-colors duration-300">
                          WhatsApp
                        </span>
                      </a>
                    ...
                    <p className="text-[10px] text-background/50 font-mono mt-5 text-center tracking-wider font-medium">
        ...
        <div className="flex items-center justify-center py-8">
          <div className="w-56 h-[2px] bg-gradient-to-r from-transparent via-primary/40 to-transparent" />
        </div>
        
        {/* Closing Moment */}
        <section className="py-20 px-6">
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xl md:text-2xl font-heading font-light text-background/70 leading-relaxed italic">
              We take on a limited number of projects each year.
            </p>
            <p className="mt-4 text-lg md:text-xl font-heading font-light text-background/50">
